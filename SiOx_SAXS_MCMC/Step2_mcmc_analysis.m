load fresult_MCMC_simultaneous_v1.mat
...
figure('position',[103,100,400,300]);
...
array2table([E_param; sqrt(V_param); E_param./sqrt(V_param); (1-tcdf(E_param./sqrt(V_param),nmcmc))*2],'RowNames',{'Mean','SD','t-stat','p-value'})
...
% ha = tight_subplot(size(acf_param_mcmc,2),1,[0.01 0.],[.1 .01],[.125 .025]);
...
%     ylabel(['ACF (',ylabel_list{ii},')']);
    ...
    text(350,0.21,ylabel_list{ii},'FontSize',8,'BackgroundColor','w');
